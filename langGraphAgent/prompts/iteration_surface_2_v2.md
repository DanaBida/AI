# Surface 2 - Iteration 2

## Tool Description

Turn the request into a concise property search query and keep the main constraint.
...
- Primary failure mode: Core constraints were better preserved, but unsupported details still leaked into some rewrites.
