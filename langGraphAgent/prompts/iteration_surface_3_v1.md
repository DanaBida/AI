# Surface 3 - Iteration 1

## Tool Description

Interpret the condition score from images.
...
- Primary failure mode: Image prompt over-interpreted scores without grounding them in visible evidence.
