# Surface 2 - Iteration 1

## Tool Description

Turn the request into a search query.
...
- Primary failure mode: Retrieval rewrite dropped important constraints from the original question.
